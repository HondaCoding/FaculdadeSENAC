...
const NoticiasStack = () => {
  return (
    <Stack.Navigator>
      <Stack.Screen name="Trabalhos" component={NoticiasScreen} />
      <Stack.Screen name="DetalhesTrablhos" component={DetalhesNoticiaScreen} />
    </Stack.Navigator>
  );
};
...
const GerenciamentoStack = () => {
  return (
    <Stack.Navigator>
      <Stack.Screen name="ListarTrabalhos" component={TabelaNoticias} />
      <Stack.Screen name="CadastroTrablho" component={CadastroNoticiaScreen} />
    </Stack.Navigator>
  );
};
